...
namespace OnnxObjectDetectionML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Andrey\AppData\Local\Temp\d996cef6-0816-465e-9039-9d6897883ffd.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.LoadImages("ImageSource_featurized", null, "ImageSource")
                                      .Append(mlContext.Transforms.ResizeImages(outputColumnName: "ImageSource_featurized", imageWidth: 800, imageHeight: 600, inputColumnName: "ImageSource_featurized"))
